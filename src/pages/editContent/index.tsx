...
import {
 Modal, Button, Spin, Popover, message,
} from 'antd';
...
const App: React.FC<{}> = () => {
    ...
    const type = useSelfReducer(state => state.type);
    ...
    return (
        <PageProvider>
            ...
            >
                <Preview type={type} cardList={list} />
            </Modal>
        </PageProvider>
    );
};
            ...
            dispatch({
                ...
                data: {
                    [pageId]: {
                        pageName: '默认页面',
                        list: [],
                        type: window.editType || 'h5',
                    },
                },
            });
            window.history.replaceState({}, '1', `/edit/${params.pro}/${pageId}`);
            return;
        }
